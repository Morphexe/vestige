-- =============================================================================
-- VESTIGE POSTGRESQL SCHEMA WITH RLS MULTI-TENANCY
-- =============================================================================
--
...
--
-- Key features:
-- - Uses TIMESTAMPTZ for timezone-aware dates
...
-- =============================================================================
--
-- After running this schema, you can use the Vestige agent-memory package:
--
-- ```typescript
...
-- });
--
-- // SQLite-style queries are automatically converted to PostgreSQL
-- const memories = await db.query(
--   "SELECT * FROM knowledge_nodes WHERE created_at > datetime('now', '-7 days')"
-- );
-- ```
--
-- RLS ensures each authenticated agent can only see their own data.
-- =============================================================================
